...
import legacy.domain.event.PaymentCanceledEvent;
import legacy.domain.event.PaymentCompletedEvent;
import legacy.domain.event.PaymentFailedEvent;
import legacy.domain.event.PaymentRequestedEvent;
import legacy.domain.exception.DuplicatePaymentException;
import legacy.domain.exception.PaymentNotFoundException;
import legacy.domain.service.ApprovePayment;
import legacy.domain.service.ApproveResult;
import legacy.domain.service.CancelPayment;
import legacy.domain.service.CancelResult;
